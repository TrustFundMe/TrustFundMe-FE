...
/**
 * GET /api/feed-posts/admin - Get all feed posts (admin, no visibility filter)
 */
export async function GET(request: NextRequest) {
  try {
    ...
    const url = `${BE_API_URL}/api/feed-posts/admin${query ? `?${query}` : ""}`;
    ...
    console.error("Admin GET feed-posts error:", error);
