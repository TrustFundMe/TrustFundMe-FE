...
/**
 * PATCH /api/feed-posts/admin/[id]/status - Force update status (admin)
 */
export async function PATCH(
  ...
  try {
    ...
    const response = await fetch(`${BE_API_URL}/api/feed-posts/admin/${id}/status`, {
      method: "PATCH",
      headers: {
    ...
    console.error("Admin PATCH status error:", error);
