 ...
 */
const supabaseUrl = process.env.NEXT_PUBLIC_SUPABASE_URL || process.env.SHARED_SUPABASE_URL || '';
const supabaseAnonKey = process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || process.env.SHARED_SUPABASE_KEY || '';
