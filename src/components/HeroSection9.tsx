...
const HeroSection9 = () => {
  const heroData = {
    ...
    images: [
      'https://images.unsplash.com/photo-1593113598332-cd288d649433?q=80&w=1280&auto=format&fit=crop',
      'https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?q=80&w=1280&auto=format&fit=crop',
      'https://images.unsplash.com/photo-1469571486292-0ba58a3f068b?q=80&w=1280&auto=format&fit=crop',
    ],
  };
