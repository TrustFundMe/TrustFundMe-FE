          ...
          conversations.map((c) => {
            ...
            return (
              <button 
                ...
                style={{ backgroundColor: active ? '#014091' : 'white', boxShadow: 'inset 0 0 0 1px rgba(0,0,0,0.04)' }}
              >
                {c.avatar ? (
                  <img 
                    src={c.avatar} 
                  ...
                  <div 
                    ...
                    style={{ backgroundColor: active ? 'white' : '#8abdfe', color: '#014091' }}
                  >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between">
                    <p 
                      ...
                      style={{ color: active ? 'white' : '#014091' }}
                    >
                      {c.name}
                    </p>
                    <span className={`text-[10px]`} style={{ color: active ? '#8dcdfa' : '#9CA3AF' }}>
                      {c.time}
                    </span>
                  </div>
                  <p className={`truncate text-xs`} style={{ color: active ? '#8dcdfa' : '#5f6777' }}>
                    {c.lastMessage}
                  </p>
                </div>
                {c.unread && (
                  <span 
                    ...
                    style={{ backgroundColor: active ? 'white' : '#8dcdfa', color: '#014091' }}
                  >
                    {c.unread}
                  </span>
                )}
