...
export const seedState: NewCampaignTestState = {
  ...
  budgetLines: [
    ...
    },
    {
      ...
      milestoneId: 'm1',
      category: 'OPERATIONS',
      title: 'Chi phí tổ chức phân phối',
    ...
    },
    {
      ...
      milestoneId: 'm3',
      category: 'DIRECT_AID',
      title: 'Hỗ trợ ổn định sau lũ',
      plannedAmount: 250000000,
      priority: 1,
      notes: '',
    },
    {
      ...
      title: 'Kiểm toán & báo cáo cuối kỳ',
      plannedAmount: 100000000,
      priority: 2,
      notes: '',
    },
