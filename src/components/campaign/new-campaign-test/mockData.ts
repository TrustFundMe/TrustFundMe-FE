...
export const mockBanks = [
  { code: 'VCB', name: 'Ngân hàng TMCP Ngoại Thương Việt Nam', shortName: 'Vietcombank', logoUrl: 'https://placehold.co/80x80/111827/ffffff?text=V' },
  { code: 'TCB', name: 'Ngân hàng TMCP Kỹ Thương Việt Nam', shortName: 'Techcombank', logoUrl: 'https://placehold.co/80x80/1e3a5f/ffffff?text=T' },
  { code: 'BIDV', name: 'Ngân hàng TMCP Đầu tư và Phát triển Việt Nam', shortName: 'BIDV', logoUrl: 'https://placehold.co/80x80/0f5132/ffffff?text=B' },
  { code: 'CTG', name: 'Ngân hàng TMCP Công thương Việt Nam', shortName: 'VietinBank', logoUrl: 'https://placehold.co/80x80/7a0019/ffffff?text=I' },
  { code: 'MBB', name: 'Ngân hàng TMCP Quân Đội', shortName: 'MB', logoUrl: 'https://placehold.co/80x80/1428a0/ffffff?text=M' },
  { code: 'ACB', name: 'Ngân hàng TMCP Á Châu', shortName: 'ACB', logoUrl: 'https://placehold.co/80x80/0d47a1/ffffff?text=A' },
  { code: 'VPB', name: 'Ngân hàng TMCP Việt Nam Thịnh Vượng', shortName: 'VPBank', logoUrl: 'https://placehold.co/80x80/6a1b9a/ffffff?text=VP' },
] as const;
...
export const seedState: NewCampaignTestState = {
  ...
  bankProofFiles: [{ id: 'bp1', name: 'sao-ke-che-so-du.pdf', sizeKb: 512 }],
  acknowledgements: {
    legalRead: true,
    slaAccepted: true,
